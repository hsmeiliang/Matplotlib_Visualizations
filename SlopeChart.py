# -*- coding: utf-8 -*-
"""
Created on Wed Oct 19 13:24:31 2022
...
# Points
ax.scatter(y = df['1952'], x = np.repeat(1, df.shape[0]), s = 10, 
           color = 'black', alpha = 0.7)
ax.scatter(y = df['1957'], x = np.repeat(3, df.shape[0]), s = 10, 
           color = 'black', alpha = 0.7)
...
for p1, p2, c in zip(df['1952'], df['1957'], df['continent']):
    ...
    ax.text(3-0.05, p2, c + ',' + str(round(p2)), horizontalalignment = 'right')
